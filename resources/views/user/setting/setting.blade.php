                     ...
                     <div class="card card-primary card-outline">
                      <div class="card-body box-profile">
                        <div class="text-center">
                          ...
                          <img class="profile-user-img img-fluid img-circle" src="{{ asset('public/uploads/'.Auth::user()->image)}}" alt="User profile picture">
                          @else
                  ...
                  <div class="col-md-6">
                   <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <strong><i class="fas fa-phone-square"></i></i> Phone</strong>
                      <p class="text-muted">{{ Auth::user()->mobile_no }}</p>
                      <hr>

                      <strong><i class="fas fa-globe-asia"></i> Country</strong>
              ...
              <form method="POST" action="{{ url('/') }}/user/profile-update/{{ Auth::user()->id  }}" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                    <div class="form-group">
                      <div class="form-line">
                        <input type="text" id="email_address_2" class="form-control" placeholder="Enter your phone number" name="mobile_no" value="{{ Auth::user()->mobile_no }}">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                    <div class="form-group">
                      <div class="form-line">
                        <input type="text" id="email_address_2" class="form-control" placeholder="Enter your country" name="country" value="{{ Auth::user()->country }}">
                      </div>
                    </div>
                  </div>
                </div>
