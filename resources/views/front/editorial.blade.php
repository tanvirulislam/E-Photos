...
<div class="container-relative in-front">
    ...
    <script>
        ...
        <div class="grey white-smoke" data-t="discover-collections-section">
            ...
            <div style="background: white" class="padding-medium">
                    ...
                    <div style="margin-top: 50px;" class="row with-gutter">
                        ...
                        <div class=" column on-small-12 on-medium-12 on-large-4">
                            <div class="padding-bottom-xlarge">
                                <a href="#" class="js-landing-page-analytics-link container-block card   card--hoverable center-block whitesmoke" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
        ...
        <div style="margin-top: -22px;" class="padding-medium view-container view-container--default motmot ">
            <div class="container-large-max padding-top-large">
                <div class="row with-gutter">
                    <h1 style=" padding: 18px 77px;
                                font-size: 41px;
                                font-family: 'Playfair Display', serif;
                                line-height: 1.5;
                                text-align: center;
                                color:#787878;" >Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe animi vel provident fugiat, quam consequuntur! Sequi quae atque harum sapiente.
                                </h1>
                    <br>
                        ...
                        <div class="padding-bottom-xlarge">
                            <a href="#" class=" card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-2" data-ingest-clicktype="collection-card-2" data-ingest-card-title="Premium stock images">
                                ...
                                <div style="text-align: center;" class="card__content container-small-min-height ">
                                    <h3  class="no-margin">
                                        <strong style="    font-size: 26px;color: #a3bdd4;font-family: sans-serif;" class="grey gravel-text" data-t="discover-collections-card-2-title">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Distinctio natus, nobis deserunt similique </strong>
                                    </h3>
    ...
    <div style="margin-top: -22px;" class="center_p">
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non totam tempora eligendi rem architecto deleniti similique aperiam, quo doloremque illo!</p>
        <br>
        <button type="button" class="btn btn-primary banner_btn">See more</button>
    </div>
</div>
