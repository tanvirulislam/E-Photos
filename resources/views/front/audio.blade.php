                            ...
                            <div class="padding-top-large padding-bottom-large">
                                <div class="center-align">
                                    <div class="container-inline-block">
                                        <div class="container-table">
                                            <div class="container-table-cell">
                                                <span class="white-text text-large light" data="fmf-promo-text-long">Get 10 free E-PHOTOS music tracks.</span>
                                            </div>
                                            <div class="container-table-cell">
                ...
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                            ...
                            margin-bottom: 7px;
                            margin-top: 25px;
                            text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Browse genre collections</h2>
                        </div>
                        <div class="audio_p">
                            Discover royalty-free music to fit any type of content
                        </div>

                        @foreach( $audio -> take(3) as $item_one)
                        <div class="column on-small-12 on-medium-4 on-large-4">
                            <div class="padding-bottom-xlarge">
                                <a href="#" class="js-landing-page-analytics-link  card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                    <div class="card__image">
                                        <picture>
                                        <source srcset="{{asset('public/storage/uploads/image')}}/{{ $item_one->picture }}" alt="Picture" type="image/webp" />
                                            <img src="{{asset('public/storage/uploads/image')}}/{{ $item_one->picture }}" alt="Picture"  data-t="discover-collections-card-1-hero-image" />
                                        </picture>
                                    </div>
                                    <div class="card__content container-small-min-height audio_card_color">
                                        <h3 class="no-margin">
                                            <strong class="grey gravel-text" data-t="discover-collections-card-1-title">{{ $item_one -> category }}</strong>
                                        </h3>
                                        <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">{{ $item_one -> audio_desp }}</span></p>
                                    </div>
                                </a>
                ...
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                            ...
                            margin-bottom: 7px;
                            margin-top: 25px;
                            text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Browse mood collections</h2>
                        </div>
                        <div class="audio_p">
                            Find stock music that evokes or underscores feelings
                        </div>

                        @foreach( $audio -> take(3) as $item_two)
                        <div class="column on-small-12 on-medium-4 on-large-4">
                            <div class="padding-bottom-xlarge">
                                <a href="" class="js-landing-page-analytics-link  card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                    <div class="card__image">
                                        <picture>
                                        <source srcset="{{asset('public/storage/uploads/image')}}/{{$item_two -> picture}}" type="image/webp" />
                                            <img src="{{asset('public/storage/uploads/image')}}/{{ $item_two -> picture }}" data-t="discover-collections-card-1-hero-image" />
                                        </picture>
                                    </div>
                                    <div class="card__content container-small-min-height audio_card_color">
                                        <h3 class="no-margin">
                                        ...
                                        <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">{{ $item_two -> audio_desp }}</span></p>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                            ...
                            margin-bottom: 7px;
                            margin-top: 25px;
                            text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">High-quality stock audio from our partners
                        </h2>
                    </div>
                    <div class="audio_p">
                        Curated collections of royalty-free music to make your projects stand out
                    </div>

                    @foreach( $audio -> take(2) as $item )
                    <div class="col-6 column on-small-12 on-medium-6 on-large-6">
                        <div class="" >
                            <a href="#" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                    <picture>
                                        <source srcset="{{asset('public/storage/uploads/image')}}/{{ $item->picture }}" type="image/webp" />
                                        <img src="{{asset('public/storage/uploads/image')}}/{{ $item->picture }}" data-t="discover-collections-card-1-hero-image" />
                                    </picture>
                                </div>
                                <div class="card__content container-small-min-height audio_card_color">
                                    <h3 class="no-margin">
                                    ...
                                    <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">{{ $item -> audio_desp }}.</span></p>
                                </div>
                            </a>
                        </div>
                    </div>
        ...
        <div style="margin-top: -35px;" class="padding-medium">
            <div class="container-large-max padding-top-large">
                <div class="row with-gutter">
                        ...
                        <div class="" >
                            <a href="" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                    <picture>
                                    <source srcset="{{asset('public/storage/uploads/image')}}/{{ $item->picture }}" type="image/webp" />
                                        <img style="padding: 15%;" src="{{asset('public/storage/uploads/image')}}/{{ $item->picture }}" data-t="discover-collections-card-1-hero-image" />
                                    </picture>
                                </div>
                    ...
                    <div style="padding: 6%;" class="column on-small-12 on-medium-6 on-large-6">
                        <div class="padding-bottom-xlarge">
                            <a href="" class="analytics-link card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-2" data-ingest-clicktype="collection-card-2" data-ingest-card-title="Premium stock images">
                                <div class="card__image">

                                </div>
                                <div class="card__content container-small-min-height audio_card_color">
                                    <h3 class="no-margin">
                                        <strong class="grey gravel-text" data-t="discover-collections-card-2-title">{{$item -> category}}</strong>
                                    </h3>
                                    <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-2-description">{{ $item->audio_desp }}</span></p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div style="padding: 6%;" class="column on-small-12 on-medium-6 on-large-6">
                        <div class="padding-bottom-xlarge">
                            <a href="" class="analytics-link card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-2" data-ingest-clicktype="collection-card-2" data-ingest-card-title="Premium stock images">
                                ...
                                <div class="card__content container-small-min-height audio_card_color">
                                    <h3 class="no-margin">
                                        <strong class="grey gravel-text" data-t="discover-collections-card-2-title">{{ $item_one->category }}</strong>
                                    </h3>
                                    <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-2-description">{{ $item_one->audio_desp }}</span></p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-6 column on-small-12 on-medium-6 on-large-6">
                        <div class="padding-bottom-xlarge" >
                            <a href="" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                    <picture>
                                        <source srcset="{{asset('public/storage/uploads/image')}}/{{ $item_one->picture }}" type="image/webp" />
                                        <img style="padding: 15%;" src="{{asset('public/storage/uploads/image')}}/{{ $item_one->picture }}" data-t="discover-collections-card-1-hero-image" />
                                    </picture>
                                </div>
        ...
        <div style="margin-top: -50px;" class="padding-medium">
            <div class="container-large-max padding-top-large">
                <div class="row with-gutter">
                    ...
                    @foreach( $audio -> take(4) as $item )
                    <div class="col-6 column on-small-12 on-medium-6 on-large-3">
                        <div class="padding-bottom-xlarge" >
                            <a href="#" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                <picture>
...
<div class="container">
<img class="audio_footer_banner" src="{{asset('public/front/images/music_banner.jpg')}}" alt="Cinque Terre" width="1000" height="300">
    <div class="center">
        <h1>Enhance any project with E-PHOTOS audio</h1>
        
    </div>
    <div class="center_p">
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus quibusdam animi molestiae, ducimus consequuntur magnam sit iste distinctio. Tempore, ut.</p>
