                                            ...
                                            <div class="container-table-cell no-stretch">
                                                <div class="select-box input-box__select-box">
                                                    <select name="slug" class="js-filter-view-type" data-t="filter-asset-type">
														...
														<option value="{{$item->id}}" data-ingest-clicktype="images-asset-dropdown-selection" 
                ...
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                            ...
                            margin-bottom: 7px;
                            margin-top: 25px;
                            text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Curated collection of E-PHOTOS photos</h2>
                        </div>
                        <div class="audio_p">
                       <h3> Subcategory product</h3>
                        ...
                        <div class="photo_card_padding column on-small-12 on-medium-6 on-large-4">
                            <div  class="padding-bottom-xlarge">
                                <a href="{{route('product_view', $item->subcat_id)}}" class="js-landing-page-analytics-link card--shadow card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                    ...
                                    <div style="height:125px;" class="card__content container-small-min-height audio_card_color">
                                        <h3 class="no-margin">
                                            <strong class="grey gravel-text" data-t="discover-collections-card-1-title"><a href="{{route('product_view', $item->subcat_id)}}">{{ $item ->subcategory_info ->subcategory_name }}</a></strong>
                                        </h3>
            ...
            <div style="margin-top: -35px;" class="padding-medium">
                <div class="container-large-max padding-top-large">
                    ...
                    <div class="col-3 column on-small-12 on-medium-6 on-large-3">
                        <div  class="padding-bottom-xlarge" >
                            <a href="{{route('product_view', $item_two->subcat_id )}}" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                    <picture>
                                    <source srcset="{{asset('public/storage/uploads/image/water_mark')}}/{{$item_two->image}}" type="image/webp" />
                                        <img style="height: 180px;" src="{{asset('public/storage/uploads/image/water_mark')}}/{{$item_two->image}}" data-t="discover-collections-card-1-hero-image" />
                                    </picture>
                                </div>
                                <div style="height:105px;" class="card__content container-small-min-height audio_card_color">
                                    <h3 class="no-margin">
                                        <strong class="grey gravel-text" data-t="discover-collections-card-1-title"><a href="{{route('product_view', $item_two->subcat_id)}}">{{ $item_two ->product_name }}</a></strong>
                                    </h3>
                                    <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">{{ $item_two -> description }}</span></p>
                                </div>
                            </a>
                        </div>
                    </div>
...
<div class="container">
    ...
    <div class="center_p">
    <p>
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt et similique sed nihil placeat quas ipsum debitis sunt quaerat odit?
    </p>
        ...
        <div class="padding-medium view-container view-container--default motmot grey white-smoke">
            <div class="container-large-max padding-top-large">
                <div class="row with-gutter">
                    ...
                    <div class="column on-small-12 on-medium-6 on-large-6">
                        <div class="" >
                            <a href="{{route('product_view', $item_three->subcat_id)}}" class="card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                <div class="card__image">
                                    <picture>
                                    <source srcset="{{asset('public/storage/uploads/image/water_mark')}}/{{ $item_three -> image }}" type="image/webp" />
                                        <img style="height:280px" src="{{asset('public/storage/uploads/image/water_mark')}}/{{ $item_three -> image }}" data-t="discover-collections-card-1-hero-image" />
                                    </picture>
                                </div>
                                <div style="height:180px" class="card__content container-small-min-height audio_card_color">
                                    <h3  class="no-margin">
                                        <strong class="grey gravel-text" data-t="discover-collections-card-1-title"><a href="{{route('product_view', $item_three->subcat_id)}}">{{ $item_three -> subcategory_info ->subcategory_name }}</a></strong>
                                    </h3>
            ...
            <div class="container">
                ...
                <div class="center_p">
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequatur illo impedit excepturi in! Et repudiandae quo officia inventore, modi illo!</p>
