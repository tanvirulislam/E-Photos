...
<div class="container-relative in-front">
    ...
    <script>
        ...
        <div class="grey white-smoke" data-t="discover-collections-section">
            ...
            <div class="padding-medium" style=" background-color:white;">
                <div class="container-large-max padding-top-large">
                    <div class="center-align">
                        <div class="padding-left-xlarge padding-right-xlarge">
                            <h3 class="no-margin">
                                Create faster with artist-designed templates available inside your Creative Cloud apps.
                            </h3>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 50px;" class="row with-gutter">
                        <div class=" column on-small-12 on-medium-12 on-large-6">
                            <div class="padding-bottom-xlarge">
                                <a href="" class="js-landing-page-analytics-link container-block  card   card--hoverable center-block white" data-t="discover-collections-card-2" data-ingest-clicktype="collection-card-2" data-ingest-card-title="Premium stock images">
                                    <div class="card__image">
                                        <picture>
                                            <source srcset="{{asset('public/front/images/div.jpg')}}" type="image/webp" />
                                            <img src="{{asset('public/front/images/div.jpg')}}" data-t="discover-collections-card-2-hero-image" />
                                        </picture>
                                    </div>
                                    <div style="text-align: center;" class="whitesmoke_bg card_bg_color card__content container-small-min-height audio_card_color">
                                        <h3 class="whitesmoke_bg no-margin">
                                            <strong class="grey gravel-text" data-t="discover-collections-card-1-title">Stock photos</strong>
                                        </h3>
                                        <p class="whitesmoke_bg no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">Beautiful and inspiring royalty-free stock images.</span></p>
...
<img class="audio_footer_banner" src="{{asset('public/front/images/memorible_background.jpg')}}" alt="Cinque Terre" width="1000" height="300">
    ...
    <div class="center_p">
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum facilis commodi reiciendis fugit voluptate iusto quisquam, veritatis dolorum accusamus eos.</p>
        <br>
