                ...
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                            ...
                            margin-bottom: 7px;
                            margin-top: 25px;
                            text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Explore royalty-free stock illustrations</h2>
                        </div>
                        <div class="audio_p">
                        Find high-quality stock art to fit your needs</div>
...
<div class="container">
    ...
    <div class="center_p">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque numquam aut iure, adipisci laborum optio alias! Facilis adipisci beatae mollitia.</p>
    ...
    <div class="container-large-max padding-top-large">
        <div class="row with-gutter">
            <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                ...
                margin-bottom: 7px;
                margin-top: 25px;
                text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Explore our curated stock illustrations</h2>
            </div>
            <div class="audio_p">
...
<div class="container">
    ...
    <div class="center_p">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae eum praesentium in ducimus reprehenderit animi alias quas exercitationem consectetur dolorem?</p>
