                    ...
                    <div class="padding-left-xlarge padding-right-xlarge padding-bottom-small">
                        <div class="margin-bottom-xlarge center-align">
                            <div class="container-max">
                                <h1 class="no-margin">
                                    <span class="white-text text-xslarge light" data-t="main-header-title">Discover E-PHOTOS free photos, vectors and videos</span>
                                </h1>
                            </div>
                        </div>
            ...
            <div  class="padding-medium">
                <div class="container-large-max padding-top-large">
                    <div class="row with-gutter">
                        ...
                        <div class="audio_p">
                            Enhance your next project with beautiful, hand-picked stock photography
                        </div>
                            ...
                            <div class="padding-bottom-xlarge">
                                <a href="#" class="js-landing-page-analytics-link  card card--small card--shadow card--hoverable center-block white" data-t="discover-collections-card-1" data-ingest-clicktype="collection-card-1" data-ingest-card-title="Stock photos">
                                    ...
                                    <div class="card__content container-small-min-height audio_card_color">
                                        <h3 class="no-margin">
                                            <strong class="grey gravel-text" data-t="discover-collections-card-1-title">Stock photos</strong>
                                        </h3>
                                        <p class="no-margin"><span class="grey gravel-text" data-t="discover-collections-card-1-description">Beautiful and inspiring royalty-free stock images.</span></p>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container-large-max padding-top-large">
                        <div class="row with-gutter">
                            <div style="padding: 0px 13px;" class="sc-bwzfXH IbGp">
                                ...
                                margin-bottom: 7px;
                                margin-top: 25px;
                                text-align: left;" class="sc-htpNat sc-ifAKCX iTkTzy">Explore popular royalty-free stock photo categories</h2>
                            </div>
                            <div class="audio_p">
                                Explore popular stock photos to find the perfect option for you
                            </div>

                            <div class="col-3 column on-small-12 on-medium-3 on-large-3">
                                <div class="padding-top-large" >
...
<div class="container">
    ...
    <div class="center_p">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. In, unde est minus itaque iusto dolorum nam suscipit cupiditate nulla nobis?</p>
...
<div class="container_innerdiv">
    ...
    <div class="center_p">
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro beatae animi explicabo reprehenderit mollitia officia ducimus quas ipsam magni. Harum!</p>
