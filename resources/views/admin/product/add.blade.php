      ...
      <div class="card" style="padding: 13px">
        ...
        <form method="post" action="{{route('admin.product.store')}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="file" name="image" multiple class="form-control" id="exampleFormControlInput1" placeholder="Product Image">
          </div>
              ...
              success:function(data){
                  ...
                  //console.log('success');
                   ...
                   for(var i=0;i<data.length;i++){
                    op+='<option value="'+data[i].slug+'">'+data[i].subcategory_name+'</option>';
                  }
                  // console.log(op)
